...
export class ViewShiftComponent implements OnInit, OnDestroy {
	...
	createForm() {
			this.shiftForm = this.shiftFB.group({
				...
				department: [{value: this.shift.department._id, disabled: true},Validators.required],
				division: [{value: this.shift.division._id, disabled: true},Validators.required],
				startTime: [{value: this.shift.start_schedule, disabled: true}, Validators.required],
				endTime: [{value: this.shift.end_schedule, disabled: true}, Validators.required],
