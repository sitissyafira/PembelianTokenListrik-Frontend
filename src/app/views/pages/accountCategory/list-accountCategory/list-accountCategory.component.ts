...
@Component({
	selector: 'kt-list-accountCategory',
	templateUrl: './list-accountCategory.component.html',
	styleUrls: ['./list-accountCategory.component.scss']
})
export class ListAccountCategoryComponent implements OnInit, OnDestroy {
	file;
	...
	// Navigate Route
	navMatTab: any[] = [
		{ name: "Balance Sheet", value: "bs", tab: true },
		{ name: "Profit & Loss", value: "pl", tab: false },
	]
	...
	editItem(id: string) {
		const url = `/accountCategory/edit/${id}`;
