...
import { LogFinanceDeleted, LogFinancePageRequested } from '../../../../../core/log/logFinance/logFinance.action';
...
@Component({
	selector: 'kt-list-logFinance',
	templateUrl: './list-logFinance.component.html',
	styleUrls: ['./list-logFinance.component.scss']
})
export class ListLogFinanceComponent implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Log Account Receive');
	...
	loadLogFinanceList() {
		...
		this.store.dispatch(new LogFinancePageRequested({ page: queryParams }));
		this.selection.clear();
	}
