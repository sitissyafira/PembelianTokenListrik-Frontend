...
import { LogFinanceDeleted, LogFinancePageRequestedQU, LogFinancePageRequestedSI } from '../../../../../core/log/logFinance/logFinance.action';
...
@Component({
	selector: 'kt-list-logFinanceSI',
	templateUrl: './list-logFinanceSI.component.html',
	styleUrls: ['./list-logFinanceSI.component.scss']
})
export class ListLogFinanceComponentSI implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Log Stock In');
	...
	loadLogFinanceList() {
		...
		this.store.dispatch(new LogFinancePageRequestedSI({ page: queryParams }));
		this.selection.clear();
	}
