...
import { LogFinanceDeleted,  LogFinancePageRequestedPD,} from '../../../../../core/log/logFinance/logFinance.action';
...
@Component({
	selector: 'kt-list-logFinancePD',
	templateUrl: './list-logFinancePD.component.html',
	styleUrls: ['./list-logFinancePD.component.scss']
})
export class ListLogFinanceComponentPD implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Log Product');
	...
	loadLogFinanceList() {
		...
		this.store.dispatch(new LogFinancePageRequestedPD({ page: queryParams }));
		this.selection.clear();
	}
