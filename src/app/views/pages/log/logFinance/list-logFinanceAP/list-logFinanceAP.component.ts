...
import { LogFinanceDeleted, LogFinancePageRequested, LogFinancePageRequestedAP } from '../../../../../core/log/logFinance/logFinance.action';
...
@Component({
	selector: 'kt-list-logFinanceAP',
	templateUrl: './list-logFinanceAP.component.html',
	styleUrls: ['./list-logFinanceAP.component.scss']
})
export class ListLogFinanceComponentAP implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Log Account Payment');
	...
	loadLogFinanceList() {
		...
		this.store.dispatch(new LogFinancePageRequestedAP({ page: queryParams }));
		this.selection.clear();
	}
