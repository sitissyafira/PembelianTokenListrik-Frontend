...
import { LogFinanceDeleted, LogFinancePageRequested, LogFinancePageRequestedAP, LogFinancePageRequestedPO, LogFinancePageRequestedPR } from '../../../../../core/log/logFinance/logFinance.action';
...
@Component({
	selector: 'kt-list-logFinancePO',
	templateUrl: './list-logFinancePO.component.html',
	styleUrls: ['./list-logFinancePO.component.scss']
})
export class ListLogFinanceComponentPO implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Log Purchase Order');
	...
	loadLogFinanceList() {
		...
		this.store.dispatch(new LogFinancePageRequestedPO({ page: queryParams }));
		this.selection.clear();
	}
