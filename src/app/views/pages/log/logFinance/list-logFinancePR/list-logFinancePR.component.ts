...
import { LogFinanceDeleted, LogFinancePageRequested, LogFinancePageRequestedAP, LogFinancePageRequestedPR } from '../../../../../core/log/logFinance/logFinance.action';
...
@Component({
	selector: 'kt-list-logFinancePR',
	templateUrl: './list-logFinancePR.component.html',
	styleUrls: ['./list-logFinancePR.component.scss']
})
export class ListLogFinanceComponentPR implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Log Purchase Request');
	...
	loadLogFinanceList() {
		...
		this.store.dispatch(new LogFinancePageRequestedPR({ page: queryParams }));
		this.selection.clear();
	}
