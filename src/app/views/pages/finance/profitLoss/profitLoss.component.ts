...
// Services
import { ProfitLossService } from '../../../../core/finance/profitLoss/profitLoss.service';
...
export class ProfitLossComponent implements OnInit, OnDestroy {
  ...
  getPreviewSource() {
    ...
    this.processSaving()
    const subPreview = this.profitLossService.generatePDF({ ...this.date, column: this.selection.selected }).subscribe(
      resp => {
