...
@Component({
	selector: 'kt-add-taskManagementMaster',
	templateUrl: './add-taskManagementMaster.component.html',
	styleUrls: ['./add-taskManagementMaster.component.scss']
})
export class AddTaskManagementMasterComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		...
		const routeSubscription = this.activatedRoute.params.subscribe(params => {
			this.taskManagementMaster = new TaskManagementMasterModel()
			this.taskManagementMaster.clear()
	...
	createForm() {
		this.taskManagementMasterForm = this.taskManagementMasterFB.group({
			...
			repeat: [{ value: "", disabled: false }, Validators.required],
			...
			task_desc: [{ value: "", disabled: false }, Validators.required],
			// remark: [{ value: "", disabled: false }, Validators.required],
			remark: this.taskManagementMasterFB.array([this.taskManagementMasterFB.group({
	...
	onSubmit(withBack: boolean = false) {
		const _title = 'Task'
		const _description = 'Are you sure to create this Task?';
		...
		dialogRef.afterClosed().subscribe(res => {
			...
			this.addTaskManagementMaster(editedTaskManagementMaster, withBack);
		});
	}
	...
	addTaskManagementMaster(_taskManagementMaster: TaskManagementMasterModel, withBack: boolean = false) {
		const addSubscription = this.taskManagementMasterService.createTaskManagementMaster(_taskManagementMaster).subscribe(
			res => {
	...
	getComponentTitle() {
		let result = 'Add Task Management Master';
		return result;
	}
	onAlertClose($event) {
		this.hasFormErrors = false;
