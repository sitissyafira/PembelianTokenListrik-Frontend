...
@Component({
  selector: 'kt-edit-taskManagementMaster',
  templateUrl: './edit-taskManagementMaster.component.html',
  styleUrls: ['./edit-taskManagementMaster.component.scss']
})
export class EditTaskManagementMasterComponent implements OnInit, OnDestroy {
	...
	createForm() {
			this.taskManagementMasterForm = this.taskManagementMasterFB.group({
				id: [{value: this.taskManagementMaster._id, disabled: false},Validators.required],
				department: [{value: this.taskManagementMaster.department, disabled: false},Validators.required],
				division: [{value: this.taskManagementMaster.division, disabled: false},Validators.required],
				user: [{value: this.taskManagementMaster.user, disabled: false}],
				repeat: [{value: this.repeatOptions.find(obj => obj.value === this.taskManagementMaster.repeat), disabled: false},Validators.required],
				checkpoint: [{value: this.taskManagementMaster.checkpoint, disabled: false},Validators.required],
				start_date: [{value: this.taskManagementMaster.start_date, disabled: false},Validators.required],
				// end_date: [{value: "", disabled: false},Validators.required],
				start_time: [{value: this.taskManagementMaster.start_time, disabled: false},Validators.required],
				end_time: [{value: this.taskManagementMaster.end_time, disabled: false},Validators.required],
				task_desc: [{value: this.taskManagementMaster.task_desc, disabled: false},Validators.required],
				remark: this.taskManagementMasterFB.array(this.taskManagementMaster.remark.map(el => 
					this.taskManagementMasterFB.group({
						...
						deskripsi: new FormControl(el.deskripsi),
	...
	prepareTaskManagementMaster(): TaskManagementMasterModel {
		...
		_taskManagementMaster.task_desc = controls.task_desc.value
	...
	getComponentTitle() {
		let result = 'Edit Task Management Master';
		return result;
	}
	onAlertClose($event) {
		this.hasFormErrors = false;
