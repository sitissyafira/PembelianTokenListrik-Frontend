...
@Component({
  selector: 'kt-edit-billCom',
  templateUrl: './edit-billCom.component.html',
  styleUrls: ['./edit-billCom.component.scss']
})
export class EditBillComComponent implements OnInit, OnDestroy {
	codenum
	type;
	billstats;
