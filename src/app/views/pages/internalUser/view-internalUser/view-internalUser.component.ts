...
@Component({
  selector: 'kt-view-internalUser',
  templateUrl: './view-internalUser.component.html',
  styleUrls: ['./view-internalUser.component.scss']
})
export class ViewInternalUserComponent implements OnInit, OnDestroy {
	...
	createForm() {
			...
			this.internalUserForm = this.internalUserFB.group({
				...
				name: [{value: this.internalUser.name, disabled: true},Validators.required],
				email: [{value: this.internalUser.email, disabled: true}, Validators.required],
				birth_date: [{value: this.internalUser.birth_date, disabled: true}, Validators.required],
				join_date: [{value: this.internalUser.join_date, disabled: true}, Validators.required],
				phone: [{value: this.internalUser.phone, disabled: true}, Validators.required],
				department: [{value: this.internalUser.department._id, disabled: true}, Validators.required],
				division: [{value: this.internalUser.division._id, disabled: true}],
				location: [{value: this.internalUser.location._id, disabled: true}, Validators.required],
				shift: [{value: this.internalUser.shift? this.internalUser.shift._id: "", disabled: true}, Validators.required],
			});
	...
	onSubmit(withBack: boolean = false) {
		...
		dialogRef.afterClosed().subscribe(res => {
			...
			this.addInternalUser(editedInternalUser, withBack);
			});
	}
	...
	addInternalUser( _internalUser, withBack: boolean = false) {
		const addSubscription = this.internalUserService.createInternalUser(_internalUser).subscribe(
			res => {
