...
import {
	selectInternalUserActionLoading,
...
@Component({
  selector: 'kt-add-internalUser',
  templateUrl: './add-internalUser.component.html',
  styleUrls: ['./add-internalUser.component.scss']
})
export class AddInternalUserComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		...
		const routeSubscription =  this.activatedRoute.params.subscribe(params =>
			{
				this.internalUser = new InternalUserModel();
				this.internalUser.clear();
	...
	getComponentTitle() {
		let result = 'Create Internal User';
		return result;
	}
	onAlertClose($event) {
		this.hasFormErrors = false;
