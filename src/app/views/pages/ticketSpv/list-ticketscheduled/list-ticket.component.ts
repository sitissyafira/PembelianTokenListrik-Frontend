...
export class ListTicketScheduledComponent implements OnInit, OnDestroy {
	...
	matTabSelection(status) {
		if (status === "all") this.router.navigateByUrl(`/SpvTicket`, { relativeTo: this.activatedRoute });
		else if (status === "open") this.router.navigateByUrl(`/SpvTicket/open`, { relativeTo: this.activatedRoute });
		else if (status === "done") this.router.navigateByUrl(`/SpvTicket/done`, { relativeTo: this.activatedRoute });
		else if (status === "waitConfirm") this.router.navigateByUrl(`/SpvTicket/wfc`, { relativeTo: this.activatedRoute });
		else if (status === "waitSurvey") this.router.navigateByUrl(`/SpvTicket/wfsurvey`, { relativeTo: this.activatedRoute });
		else if (status === "scheduled") this.router.navigateByUrl(`/SpvTicket/sch`, { relativeTo: this.activatedRoute });
		else if (status === "reschedule") this.router.navigateByUrl(`/SpvTicket/rsh`, { relativeTo: this.activatedRoute });
		else if (status === "waitSch") this.router.navigateByUrl(`/SpvTicket/wfs`, { relativeTo: this.activatedRoute });
		else if (status === "schSurvey") this.router.navigateByUrl(`/SpvTicket/schSurvey`, { relativeTo: this.activatedRoute });
		else if (status === "reject") this.router.navigateByUrl(`/SpvTicket/reject`, { relativeTo: this.activatedRoute });
		else if (status === "svyDone") this.router.navigateByUrl(`/SpvTicket/svyDone`, { relativeTo: this.activatedRoute });
		else if (status === "scheduled") this.router.navigateByUrl(`/SpvTicket/sch`, { relativeTo: this.activatedRoute });
	}
	...
	editTicket(id) {
		const url = `/SpvTicket/edit/${id}`;
		this.router.navigateByUrl(url, { relativeTo: this.activatedRoute });
	}

	viewTicket(id) {
		const url = `/SpvTicket/view/${id}`;
		this.router.navigateByUrl(url, { relativeTo: this.activatedRoute });
	}
