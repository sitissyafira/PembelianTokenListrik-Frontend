...
@Component({
  selector: 'kt-view-managementTask',
  templateUrl: './view-managementTask.component.html',
  styleUrls: ['./view-managementTask.component.scss']
})
export class ViewManagementTaskComponent implements OnInit, OnDestroy {
	...
	displayedColumns = ["question", "description", "check", "attachment"];
	...
	createForm() {
			this.managementTaskForm = this.managementTaskFB.group({
				...
				user: [{value: this.managementTask.user.name, disabled: true},Validators.required],
				userId: [{value: this.managementTask.user._id, disabled: true},Validators.required],
				created_date: [{value: this.managementTask.start_time, disabled: true},Validators.required],
				start_time: [{value: this.managementTask.start_time? moment(this.managementTask.start_time).format("HH:mm"): "", disabled: true},Validators.required],
				end_time: [{value: this.managementTask.end_time? moment(this.managementTask.end_time).format("HH:mm"): "", disabled: true},Validators.required],
				checkpoint: [{value: this.managementTask.checkpoint.name, disabled: true},Validators.required],
				status: [{value: this.managementTask.status, disabled: true},Validators.required],
				// remark: [{value: this.managementTask.remark, disabled: true},Validators.required],
