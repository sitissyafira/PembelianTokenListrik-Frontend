...
import { TicketDeleted, TicketPageRequested, TicketPageRating, RatingDeleted } from '../../../../core/ticket/ticket.action';
...
export class ListRatingComponent implements OnInit, OnDestroy {
	...
	loadTicketList() {
		...
		this.store.dispatch(new TicketPageRating({ page: queryParams }));
		this.selection.clear();
	}
