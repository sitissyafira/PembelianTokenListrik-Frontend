...
@Component({
  selector: 'kt-popup-edit-pricequotation',
  templateUrl: './popup-edit-pricequotation.component.html',
  styleUrls: ['./popup-edit-pricequotation.component.scss']
})
export class PopupEditPricequotationComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PopupEditPricequotationComponent>,
