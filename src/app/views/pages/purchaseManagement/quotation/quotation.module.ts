...
import {quotationReducer} from '../../../../core/purchaseManagement/quotation/quotation.reducer';
import {QuotationEffect} from '../../../../core/purchaseManagement/quotation/quotation.effect';
...
@NgModule({
	imports: [
		...
		StoreModule.forFeature('quotation', quotationReducer),
		EffectsModule.forFeature([QuotationEffect]),
		FormsModule,
		ReactiveFormsModule,
	...
	entryComponents: [
		...
		QuotationComponent,
		PopupEditPricequotationComponent
	],
	declarations: [
		QuotationComponent,
