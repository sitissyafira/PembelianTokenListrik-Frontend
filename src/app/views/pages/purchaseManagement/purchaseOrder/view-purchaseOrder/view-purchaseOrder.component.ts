...
@Component({
  selector: 'kt-view-purchaseOrder',
  templateUrl: './view-purchaseOrder.component.html',
  styleUrls: ['./view-purchaseOrder.component.scss']
})
export class ViewpurchaseOrderComponent implements OnInit, OnDestroy {
	...
	createForm() {
		...
		this.purchaseOrderForm = this.purchaseOrderFB.group({
			...
			date: [{value: this.purchaseOrder.date, disabled: true}, Validators.required],
			typePO: [{value: this.purchaseOrder.type_po, disabled: true}, Validators.required],
			po_no: [{value: this.purchaseOrder.po_no, disabled: true}, Validators.required],
			pr: [{value: this.purchaseOrder.pr, disabled: true}],
			pr_name: [{value: this.purchaseOrder.pr.purchase_request_no, disabled: true}],
			vendor_id: [{value: this.purchaseOrder.vendor_name, disabled: true}],
			vendor_name: [{value: this.purchaseOrder.vendor_name.vendor_name, disabled: true}, Validators.required],
			...
			discountValue: [{value: this.purchaseOrder.payment.discountValue, disabled: true}, Validators.required],
			shippingCost: [{value: this.purchaseOrder.payment.shippingCost, disabled: true}, Validators.required],
			pph: [{value: this.purchaseOrder.payment.pph, disabled: true}, Validators.required],
			ppn: [{value: this.purchaseOrder.payment.ppn, disabled: true}, Validators.required],
			note: [{value: this.purchaseOrder.note, disabled: true}, Validators.required],
			term: [{value: this.purchaseOrder.term.term, disabled: true}, Validators.required],
			termPeriod: [{value: this.purchaseOrder.term.termPeriod, disabled: true}, Validators.required],
			discountType: [{value: this.purchaseOrder.payment.discountType, disabled: true}, Validators.required],
		...
		console.log(this.documents, 'docu')
		console.log(this.productList, 'prolist')
		console.log(this.isPreviewPdf, 'prev pdf')
