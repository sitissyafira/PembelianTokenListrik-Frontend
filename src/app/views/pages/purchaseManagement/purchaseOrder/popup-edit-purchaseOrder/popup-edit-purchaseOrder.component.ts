...
@Component({
  selector: 'kt-popup-edit-purchaseOrder',
  templateUrl: './popup-edit-purchaseOrder.component.html',
  styleUrls: ['./popup-edit-purchaseOrder.component.scss']
})
...
export class PopupEditPurchaseOrder implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PopupEditPurchaseOrder>,
