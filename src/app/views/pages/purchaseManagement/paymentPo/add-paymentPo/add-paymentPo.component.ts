...
@Component({
  selector: 'kt-add-paymentPo',
  templateUrl: './add-paymentPo.component.html',
  styleUrls: ['./add-paymentPo.component.scss']
})
export class AddpaymentPoComponent implements OnInit, OnDestroy {
	...
	createForm() {
		this.paymentPoForm = this.paymentPoFB.group({
			...
			po_receipt: [{value: "", disabled: false}, Validators.required],
			po_receipt_no: [{value: "", disabled: false}, Validators.required],

			purchase_invoice_no: [{value: "", disabled: false}, Validators.required],
			po_no: [{value: "", disabled: true}, Validators.required],
			po: [{value: "", disabled: true}, Validators.required],
			por_no: [{value: "", disabled: true}, Validators.required],
			por: [{value: "", disabled: true}, Validators.required],
			vendor_name: [{value: "", disabled: true}, Validators.required],
			ppn: [{value: "", disabled: true}, Validators.required],
			pph: [{value: "", disabled: true}, Validators.required],
			date: [this.nowDate, Validators.required],
			planned_payment_date: [this.nowDate, Validators.required],
			term: [{value: "", disabled: true}, Validators.required],
			termPeriod: [{value: "", disabled: true}, Validators.required],
			discountType: [{value: "", disabled: true}, Validators.required],
			discountValue: [{value: undefined, disabled: true}, Validators.required],
			discountNominal: [{value: undefined, disabled: true}, Validators.required],
			shippingCost: [{value: undefined, disabled: true}, Validators.required],
			notes: [{value: undefined, disabled: false}, Validators.required],
			subTotal: [{value: undefined, disabled: false}, Validators.required],
			subTotalPOR: [{value: undefined, disabled: true}, Validators.required],
			grandTotal: [{value: undefined, disabled: true}, Validators.required],
			grandTotalPOR: [{value: undefined, disabled: true}, Validators.required],
			ppnPOR: [{value: "", disabled: false}, Validators.required],
			pphPOR: [{value: "", disabled: false}, Validators.required],
			discountValuePOR: [{value: undefined, disabled: false}, Validators.required],
			shippingCostPOR: [{value: undefined, disabled: false}, Validators.required],
			
			products: this.paymentPoFB.array([this.paymentPoFB.group({
	...
	initAp() {
		...
		this.apForm = this.apFB.group({
			...
			date: [this.dateAp.value, Validators.required], // number
			createdBy: [{value:this.datauser, disabled:true}, Validators.required],
			crtdate: [{ value: this.dateAp.value, disabled: true }], // number
	...
	preparepaymentPo() {
		...
		console.log(_paymentPo, 'payment po')
	...
	getComponentTitle() {
		let result = 'Add PO Payment';
		if (!this.paymentPo || !this.paymentPo._id) {
			return result;
		}

		result = `Edit PO Payment`;
		return result;
	}
