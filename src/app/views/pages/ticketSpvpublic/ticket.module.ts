...
import { publicTicketReducer } from '../../../core/ticketpublic/publicticket.reducer';
import { PublicTicketEffect } from '../../../core/ticketpublic/publicticket.effect';
...
@NgModule({
	imports: [
		...
		StoreModule.forFeature('publicTicket', publicTicketReducer),
		EffectsModule.forFeature([PublicTicketEffect]),
		FormsModule,
		ReactiveFormsModule,
