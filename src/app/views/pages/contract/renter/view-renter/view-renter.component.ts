...
export class ViewRenterComponent implements OnInit, OnDestroy {
	...
	createForm() {
		this.renterForm = this.renterFB.group({
			cstmr: [{ value: this.renter.cstmr ? this.renter.cstmr._id : "", disabled: true }, Validators.required],
			contact_name: [{ value: this.renter.contact_name, disabled: true }],
			contact_address: [{ value: this.renter.contact_address, disabled: true }, Validators.required],
			contact_phone: [{ value: this.renter.contact_phone, disabled: true }],
			...
			checkOut: [{ value: this.renter.checkOut, disabled: true }],
			rentalAmount: [{ value: this.renter.rentalAmount, disabled: true }],
			...
			paymentType: [{ value: this.renter.paymentType, disabled: true }],
			paymentTerm: [{ value: this.renter.paymentTerm, disabled: true }],
			virtualAccount: [{ value: this.renter.virtualAccount, disabled: true }],
			norek: [{ value: this.renter.norek, disabled: true }],
			isPKP: [{ value: this.renter.isPKP, disabled: true }],
			tax_id: [{ value: this.renter.tax_id, disabled: true }],

			receipt: this.renterFB.group({
				bastu: this.renterFB.group({
					bastu1: [{ value: this.renter.receipt ? this.renter.receipt.bastu : false, disabled: true }],
				}),
				ppp: this.renterFB.group({
					ppp1: [{ value: this.renter.receipt ?  this.renter.receipt.ppp: false, disabled: true }],
				}),
				ba: this.renterFB.group({
					ba1: [{ value: this.renter.receipt ? this.renter.receipt.ba: false, disabled: true }],
				}),
				bpb: this.renterFB.group({
					bpb1: [{ value: this.renter.receipt ? this.renter.receipt.bpb: false, disabled: true }],
				}),
				kp: this.renterFB.group({
					kp1: [{ value: this.renter.receipt ? this.renter.receipt.kp: false, disabled: true }],
				}),
				kbm: this.renterFB.group({
					kbm1: [{ value: this.renter.receipt ? this.renter.receipt.kbm: false, disabled: true }],
				}),
				km: this.renterFB.group({
					km1: [{ value: this.renter.receipt ? this.renter.receipt.km: false, disabled: true }],
				}),
				ac: this.renterFB.group({
					ac1: [{ value: this.renter.receipt ? this.renter.receipt.ac: false, disabled: true }],
				}),
				ap: this.renterFB.group({
					ap1: [{ value: this.renter.receipt ? this.renter.receipt.ap: false, disabled: true }],
				}),
				sm: this.renterFB.group({
					sm1: [{ value: this.renter.receipt ? this.renter.receipt.sm: false, disabled: true }],
				}),
				sv: this.renterFB.group({
					sv1: [{ value: this.renter.receipt ? this.renter.receipt.sv: false, disabled: true }],
				}),
				bph: this.renterFB.group({
					bph1: [{ value: this.renter.receipt ? this.renter.receipt.bph: false, disabled: true }],
				}),
				ksdm: this.renterFB.group({
					ksdm1: [{ value: this.renter.receipt ? this.renter.receipt.ksdm: false, disabled: true }],
				}),
			})
		})
	}
	...
	getComponentTitle() {
		let result = 'View Check In Check Out';
		if(this.title){
			result = `View ${this.title}`;
		}
		return result;
	}
	onAlertClose($event) {
