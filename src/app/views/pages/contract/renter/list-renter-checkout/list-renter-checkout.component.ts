...
import { RenterContractActionToggleCheckout, RenterContractDeleted, RenterContractPageRequested ,RenterContractPageToggleCheckout} from '../../../../../core/contract/renter/renter.action';
...
@Component({
	selector: 'kt-list-renter-checkout',
	templateUrl: './list-renter-checkout.component.html',
	styleUrls: ['./list-renter-checkout.component.scss']
})
export class ListRenterCheckOutComponent implements OnInit, OnDestroy {
	name: string= ""
	title: string = ""
	file;
	...
	ngOnInit() {
		...
		console.log(this.dataSource.loading$,"data source")
	...
	loadList() {
		...
		this.store.dispatch(new RenterContractActionToggleCheckout({ page: queryParams }));
		this.selection.clear();
	}
