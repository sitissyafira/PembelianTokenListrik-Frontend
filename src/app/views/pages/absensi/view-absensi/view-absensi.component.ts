...
@Component({
  selector: 'kt-view-absensi',
  templateUrl: './view-absensi.component.html',
  styleUrls: ['./view-absensi.component.scss']
})
export class ViewAbsensiComponent implements OnInit, OnDestroy {
