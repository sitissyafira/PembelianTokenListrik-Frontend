...
@Component({
  selector: 'kt-add-absensi',
  templateUrl: './add-absensi.component.html',
  styleUrls: ['./add-absensi.component.scss']
})
export class AddAbsensiComponent implements OnInit, OnDestroy {
