...
import {defectReducer} from '../../../core/defect/defect.reducer';
import {DefectEffect} from '../../../core/defect/defect.effect';
import { ViewDefectComponent } from './view-defect/view-defect.component';
...
@NgModule({
	imports: [
		...
		StoreModule.forFeature('defect', defectReducer),
		EffectsModule.forFeature([DefectEffect]),
		FormsModule,
		ReactiveFormsModule,
