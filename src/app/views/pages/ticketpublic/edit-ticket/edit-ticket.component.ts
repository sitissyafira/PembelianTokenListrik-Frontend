...
export class EditTicketComponent implements OnInit, OnDestroy {
	...
	createForm() {
		...
		this.ticketForm = this.ticketFB.group({
			...
			statusTenant: [{ value: this.ticket.statusTenant ? this.ticket.statusTenant : "", disabled: true }],
			tenantName: [{ value: this.ticket.tenantName ? this.ticket.tenantName : "", disabled: true }],
		});
	}
