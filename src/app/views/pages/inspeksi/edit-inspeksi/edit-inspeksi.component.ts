...
@Component({
  selector: 'kt-edit-inspeksi',
  templateUrl: './edit-inspeksi.component.html',
  styleUrls: ['./edit-inspeksi.component.scss']
})
export class EditInspeksiComponent implements OnInit, OnDestroy {
