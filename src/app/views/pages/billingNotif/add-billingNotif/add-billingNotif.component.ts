...
@Component({
	selector: 'kt-add-billingNotif',
	templateUrl: './add-billingNotif.component.html',
	styleUrls: ['./add-billingNotif.component.scss'],
	providers: [
		{
			provide: DateAdapter,
...
export class AddbillingNotifComponent implements OnInit, OnDestroy {
	// Public properties
	...
	ngOnInit() {
		...
		// this.loadUnitList("")
		this.billingNotif = new billingNotifModel();
		this.billingNotif.clear();
	...
	createForm() {
		this.billingNotifForm = this.billingNotifFB.group({
			type_notif: [{value:"",disabled: false}, Validators.required],
			title:[{value:"",disabled: false},Validators.required],
			period:[{value:"", disabled: false}],
			start_period:[{value:"", disabled: false},],
			end_period:[{value:"",disabled:false},],
	...
	getComponentTitle() {
		let result = 'Create Billing Notifications';
