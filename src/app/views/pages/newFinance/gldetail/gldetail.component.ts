...
// Services
import { GlDetailService } from "../../../../core/newFinance/gldetail/gldetail.service";
...
import { TemplatePDFGeneralLedger } from "../../../../core/templatePDF/generalLedger.service";
...
export class GldetailComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private cdr: ChangeDetectorRef,
		private templatePDFGeneralLedger: TemplatePDFGeneralLedger,
    ...
    const subPreview = this.gldetailService
      ...
      .subscribe(
        (resp) => {
          ...
          const result = this.templatePDFGeneralLedger.generatePDFTemplateGeneralLedger(resp);
