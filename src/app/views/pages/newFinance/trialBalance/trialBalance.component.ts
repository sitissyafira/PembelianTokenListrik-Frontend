...
// Services
import { TrialBalanceService } from '../../../../core/newFinance/trialBalance/trialBalance.service';
...
import { TemplatePDFBalanceSheet } from '../../../../core/templatePDF/balanceSheet.service';
...
export class TrialBalanceComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private templatePDFBalanceSheet: TemplatePDFBalanceSheet,
  ...
  getPreviewSource() {
    ...
    this.processSaving()
    const subPreview = this.trialBalanceService
      ...
      .subscribe(
        (resp) => {
          ...
          const result = this.templatePDFBalanceSheet.generatePDFTemplateBalanceSheet(resp);
