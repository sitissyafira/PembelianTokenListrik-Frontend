...
import {
	selectExternalUserActionLoading,
...
@Component({
  selector: 'kt-add-externalUser',
  templateUrl: './add-externalUser.component.html',
  styleUrls: ['./add-externalUser.component.scss']
})
export class AddExternalUserComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		...
		const routeSubscription =  this.activatedRoute.params.subscribe(params =>
			{
				this.externalUser = new ExternalUserModel();
