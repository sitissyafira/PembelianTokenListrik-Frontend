...
@Component({
  selector: 'kt-edit-externalUser',
  templateUrl: './edit-externalUser.component.html',
  styleUrls: ['./edit-externalUser.component.scss']
})
export class EditExternalUserComponent implements OnInit, OnDestroy {
	...
	createForm() {
			...
			this.externalUserForm = this.externalUserFB.group({
				...
				name: [{value: this.externalUser.name, disabled: false},Validators.required],
				email: [{value: this.externalUser.email, disabled: false}, Validators.required],
				birth_date: [{value: this.externalUser.birth_date, disabled: false}, Validators.required],
				join_date: [{value: this.externalUser.join_date, disabled: false}, Validators.required],
				phone: [{value: this.externalUser.phone, disabled: false}, Validators.required],
				department: [{value: this.externalUser.department._id, disabled: false}, Validators.required],
				division: [{value: this.externalUser.division._id, disabled: false}],
				location: [{value: this.externalUser.location._id, disabled: false}, Validators.required],
				shift: [{value: this.externalUser.shift? this.externalUser.shift._id: "", disabled: false}, Validators.required],
			});
	...
	onSubmit(withBack: boolean = false) {
		...
		dialogRef.afterClosed().subscribe(res => {
			...
			this.updateExternalUser(editedExternalUser, withBack);
			});
	}
	...
	prepareExternalUserFormData() {
		...
		_externalUser.append("birth_date", controls.birth_date.value)
		_externalUser.append("join_date", controls.join_date.value)
	...
	updateExternalUser( _externalUser, withBack: boolean = false) {
		const addSubscription = this.externalUserService.updateExternalUser(this.externalUser._id, _externalUser).subscribe(
			res => {
