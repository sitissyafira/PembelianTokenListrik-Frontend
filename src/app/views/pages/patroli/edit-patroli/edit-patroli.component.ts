...
@Component({
  selector: 'kt-edit-patroli',
  templateUrl: './edit-patroli.component.html',
  styleUrls: ['./edit-patroli.component.scss']
})
export class EditPatroliComponent implements OnInit, OnDestroy {
