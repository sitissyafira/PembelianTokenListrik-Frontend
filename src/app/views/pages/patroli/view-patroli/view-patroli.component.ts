...
@Component({
  selector: 'kt-view-patroli',
  templateUrl: './view-patroli.component.html',
  styleUrls: ['./view-patroli.component.scss']
})
export class ViewPatroliComponent implements OnInit, OnDestroy {
